...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ ast_url('js/app.js') }}" defer></script>
    ...
    <!-- Styles -->
    <link href="{{ ast_url('css/app.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo ast_url('css/custom.css') ?>" type="text/css">
</head>
<body>
    <div id="app">
