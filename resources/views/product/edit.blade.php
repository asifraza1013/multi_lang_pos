                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                <input type="hidden" id="type" name="type_hidden" value="{{$lims_product_data->type}}">
                                <input type="hidden" name="barcode_symbology_hidden" value="{{ $lims_product_data->barcode_symbology }}">
                                <input type="hidden" name="alert_quantity" value="{{ $lims_product_data->alert_quantity }}" class="form-control">
