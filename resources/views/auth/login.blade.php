...
<html>
  <head>
    ...
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="{{ast_url('vendor/bootstrap/css/bootstrap.min.css') }}" type="text/css">
    ...
    <link rel="stylesheet" href="<?php echo ast_url('css/custom-'.$general_setting->theme) ?>" type="text/css">
    <!-- Favicon-->
...
<script type="text/javascript" src="<?php echo ast_url('js/charts-home.js') ?>"></script>
