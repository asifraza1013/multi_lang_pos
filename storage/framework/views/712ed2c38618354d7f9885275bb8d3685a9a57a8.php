                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                                <input type="hidden" id="type" name="type" name="standard">
                                <div class="col-md-6">
                                ...
                                <input type="hidden" name="alert_quantity" value="5">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="product_details" class="form-control" rows="3"><?php echo e(trans('file.dummy_text')); ?></textarea>
                                    </div>
                                </div>
